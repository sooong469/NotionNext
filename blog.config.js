...
const BLOG = {
  ...
  // 谷歌广告
  ADSENSE_GOOGLE_ID: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_ID || 'ca-pub-4686774566780043', // 谷歌广告ID e.g ca-pub-xxxxxxxxxxxxxxxx
  ...
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || 'sooong', // 站点描述，被notion中的页面描述覆盖
